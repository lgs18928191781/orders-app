    ...
    <div v-if="curPair && tokenIn && tokenOut">
        ...
        <div class="swap-sub-control-panel">
            ...
            <div class="flex h-16 items-center justify-between space-x-2">
                <input type="number" v-model="tokenInAmount"
        ...
        <div>
            <div class="relative z-30 my-0.5 flex h-0 justify-center">
                <div
                    ...
                    <ArrowDownIcon class="box-content inline h-4 w-4 rounded-lg bg-zinc-800 p-2 group-hover:hidden" />
        ...
        <div class="swap-sub-control-panel">
            ...
            <div class="flex h-16 items-center justify-between space-x-2">
                <input v-model="tokenOutAmount" type="number"
                    class="quiet-input w-12 flex-1 bg-transparent p-0 leading-loose" placeholder="0" disabled />
                <div class="flex items-center gap-1 rounded-full bg-zinc-900 p-1 px-4 text-xl">
        ...
        <div class="grid grid-rows-3 gap-y-2 mt-5 text-sm">
...
watch(tokenInAmount,
    (newVlue) => {
        ...
        const _fee = formatAmount(
            BigNumber(value).multipliedBy(curPair.value.swapFeeRate || 0).div(10000),
