    ...
    <Dialog class="relative z-30" as="div" @close="closeModal">
      ...
      <div class="fixed inset-0 overflow-y-auto text-zinc-300">
        <div class="mt-32 flex justify-center p-4 text-center">
          ...
          >
            <DialogPanel
              class="relative w-[460px] transform overflow-hidden rounded-xl bg-zinc-800 px-4 pb-4 pt-5 text-left shadow-[0_0px_10px_rgba(255,255,255,0.3)] transition-all sm:p-7"
            >
