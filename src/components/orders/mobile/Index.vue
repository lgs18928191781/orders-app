...
import OrderPanelHeader from '@/components/orders/PanelHeader.vue'
import OrderConfirmationModal from '@/components/ConfirmationModal.vue'
import MainTabs from '@/components/orders/mobile/MainTabs.vue'
