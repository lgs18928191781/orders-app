...
import { getClaimHistory } from '@/queries/events'

import { useConnectionStore } from '@/stores/connection'
import { getSwapYieldTradeFeeHistoryQuery } from '@/queries/swap-yield-reward-history.query'
...
const { data: rewardHistory } = useQuery(
  getSwapYieldTradeFeeHistoryQuery(
