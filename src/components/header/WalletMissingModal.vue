...
<template>
  <TransitionRoot as="template" :show="isWalletMissingModalOpen">
    <Dialog as="div" class="relative z-10" @close="closeWalletMissingModal" :initial-focus="goButtonRef">
            ...
            <DialogPanel
              ...
              <div>
                <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-amber-100">
                  <FrownIcon class="h-6 w-6 text-amber-500" aria-hidden="true" />
                </div>
                <div class="mt-3 text-center sm:mt-5">
                  <DialogTitle as="h3" class="text-base font-semibold leading-6 text-zinc-100">
                  ...
                  <div class="mt-2">
                    <DialogDescription class="text-sm text-zinc-500 text-center">
                      Please install
              ...
              <div class="mt-5 sm:mt-6">
                <button type="button"
                  ...
                  @click="goToMissingWallet" ref="goButtonRef">
                  Go to
